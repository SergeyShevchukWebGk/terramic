...
<?if ($params['BILL_HEADER']):?>
    <tr>
        ...
        <td style="font-size: 2em; font-weight: bold; text-align: center">
            <nobr><?=$params['BILL_HEADER'];?> <?=Loc::getMessage('SALE_HPS_BILL_SELLER_TITLE', array('#PAYMENT_NUM#' => stristr($params["ACCOUNT_NUMBER"], '/', true), '#YEAR#' => date('y'), '#DAY#' => date('z'), '#PAYMENT_DATE#' => $params["PAYMENT_DATE_INSERT"]));?>
            </nobr>
        </td>
        <td></td>
    </tr>
