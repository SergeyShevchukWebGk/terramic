                            ...
                            <?if(in_array("QUANTITY", $arParams["COLUMNS_LIST"])):?>
                                <div class="cart-item-quantity">
                                    <div style="float:right;" class="buy_more">
                                        <a href="javascript:void(0)" class="minus" onclick="setQuantity_wishlist(<?=$arBasketItems['ID']?>, 1, 'down', <?=$useFloatQuantityJS?>);"><span>-</span></a>
                                        ...
                                        <a href="javascript:void(0)" class="plus" onclick="setQuantity_wishlist(<?=$arBasketItems['ID']?>, 1, 'up', <?=$useFloatQuantityJS?>);"><span>+</span></a>
                                    </div>
