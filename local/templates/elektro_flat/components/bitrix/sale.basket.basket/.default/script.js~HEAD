...
// обновленияе количества товаров в отложенных
function setQuantity_wishlist(basketId, ratio, sign, bUseFloatQuantity) {
    var curVal = parseFloat(BX("QUANTITY_" + basketId).value),
        newVal;
    ...
    BX.ajax({
        url: '/ajax/update_wishlist.php',
        method: 'POST',
        data: {id:basketId, newVal:newVal},
        dataType: 'html',
        onsuccess: function(result) {
