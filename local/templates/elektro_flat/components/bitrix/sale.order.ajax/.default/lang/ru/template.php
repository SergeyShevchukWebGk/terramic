...
$MESS['TEXT_PARAMS'] = "Ориентировочные характеристики заказа для расчета стоимости доставки.";
$MESS['WEIGHT'] = "Вес";
$MESS['AMOUNT'] = "Объем";
$MESS['TEXT_PARAMS'] = "Ориентировочные характеристики заказа для расчета стоимости доставки.";
$MESS["PASSPORT_DATA_INFO"] = "Ваши данные паспорта: Ф.И.О., серия и номер нужны для получения товара с нашего склада или через транспортную компанию.";
$MESS["TEXT_LOCATION"] = "Город доставки должен быть с терминалом одной из транспортных компаний:<br>
&laquo;Деловые линии&raquo;, &laquo;GTD, бывший КИТ&raquo;, &laquo;ПЭК&raquo;, &laquo;Байкал Сервис&raquo;.<br>
Если в указанном городе нет терминала той или иной транспортной компании,<br>
то эта компания исчезает из списка автоматически.";
?>