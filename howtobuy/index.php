...
$APPLICATION->SetTitle("Как купить");?><h2>1. Оформление заказа</h2>
...
<p>В колонке <b>Действия</b> над каждым товаром можно произвести следующие действия: либо <b>удалить</b> товар из корзины, либо <b>добавить в список желаний</b> товар на будущее.</p>
...
<p><b>Внимание!</b> Для каждого отдельного заказа возможен только один способ оплаты на ваш выбор. Оплата заказа по частям различными способами невозможна.</p><?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>